...
typedef uf_bool_t (*uf_hw_in8_fn)(
    void *context,
    uf_io_port_t port,
    uint8_t *value
);
typedef uf_bool_t (*uf_hw_in16_fn)(
    void *context,
    uf_io_port_t port,
    uint16_t *value
);
typedef uf_bool_t (*uf_hw_in32_fn)(
    void *context,
    uf_io_port_t port,
    uint32_t *value
);
typedef uf_bool_t (*uf_hw_out8_fn)(
    void *context,
    uf_io_port_t port,
    uint8_t value
);
typedef uf_bool_t (*uf_hw_out16_fn)(
    void *context,
    uf_io_port_t port,
    uint16_t value
);
typedef uf_bool_t (*uf_hw_out32_fn)(
    void *context,
    uf_io_port_t port,
    uint32_t value
);
typedef uf_bool_t (*uf_hw_phys_read8_fn)(
    void *context,
    uf_phys_addr_t address,
    uint8_t *value
);
typedef uf_bool_t (*uf_hw_phys_write8_fn)(
    void *context,
    uf_phys_addr_t address,
    uint8_t value
);
typedef uf_bool_t (*uf_hw_delay_us_fn)(
    void *context,
    uint32_t microseconds
);
typedef uf_bool_t (*uf_hw_interrupt_state_fn)(void *context);
