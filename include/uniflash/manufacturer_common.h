...
typedef bool (*uf_flash_inner_program_fn)(struct uf_flash_service *service,
    uf_rom_offset_t position,
    uf_phys_addr_t source_address);
typedef bool (*uf_flash_inner_erase_fn)(struct uf_flash_service *service, uf_rom_offset_t sector_address);

uf_phys_addr_t uf_flash_fwh_64k_lock_address(const struct uf_flash_service *service, uf_rom_offset_t operation_address);
uf_phys_addr_t uf_flash_fwh_32k_lock_address(const struct uf_flash_service *service, uf_rom_offset_t operation_address);
